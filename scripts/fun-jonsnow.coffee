...
JonSnowPictures = [
  "http://img.huffingtonpost.com/asset/scalefit_630_noupscale/56e024e81500002a000b1742.jpeg",
  "https://pbs.twimg.com/profile_images/743138182607175680/ZJzktgBk_400x400.jpg",
  "http://static.srcdn.com/wp-content/uploads/Jon-Snow-in-Snow.jpg",
  "http://s3.r29static.com//bin/entry/119/x,80/1506356/image.jpg"
]
...
module.exports = (robot) ->
  ...
  robot.respond /what do i look like/i, (msg) ->
    msg.send "How am I supposed to know?"
  ...
  robot.respond /where is your code/i, (msg) ->
    msg.send "My code is located at https://github.hpe.com/RnDIT-SWET/hubot-ctf-xform. Feel free to take a look to see how I work!"
  ...
  robot.respond /what do you look like/i, (msg) ->
    msg.send msg.random JonSnowPictures
